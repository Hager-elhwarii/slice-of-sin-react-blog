    ...
    <div className="-m-1 flex flex-wrap md:-m-2">
      <div className="flex w-1/2 flex-wrap">
        <div className="w-1/2 p-1 md:p-2 overflow-hidden rounded-lg">
          <img
            alt="gallery"
            className="block h-full w-full rounded-lg object-cover object-center cursor-pointer ease-in duration-300 scale-100 hover:scale-110"
        ...
        <div className="w-full object-cover p-1 md:p-2 overflow-hidden rounded-lg">
          <img
            alt="gallery"
            className="block h-full w-full rounded-lg object-cover object-center cursor-pointer ease-in duration-300 scale-100 hover:scale-110"
